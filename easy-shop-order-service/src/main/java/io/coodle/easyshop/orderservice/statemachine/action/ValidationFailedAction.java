...
@Slf4j
public class ValidationFailedAction implements Action<OrderState, OrderEvent> {
    @Override
    public void execute(StateContext<OrderState, OrderEvent> stateContext) {
        ...
        log.error("Compensating Transaction...Validation Failed for order with id {} ", orderId);
    }
}
