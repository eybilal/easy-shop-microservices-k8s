package io.coodle.easyshop.customerservice;
...
public class EasyShopCustomerServiceApplication {

	public static void main(String[] args) {
		SpringApplication.run(EasyShopCustomerServiceApplication.class, args);
	}
